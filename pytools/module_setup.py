...
def moduleSetup(module_list: list, dev_mode: bool = False) -> None:
    """
    ...
    dev_mode: bool (optional)
        boolean representing whether developer mode is enabled or not, disabling or enabling module setup accordingly. defaults to False.
    ...
    if not dev_mode:
        ...
        if not data["module_setup_status"]:
            ...
            print(
                "the project is now set up, you should not need to do this again.")
            time.sleep(2)
